...
#### Step 4: Add Analytics Sync (Yes Branch)
...
6. **Body:** (This is a placeholder - actual sync will happen in the template)
   ```json
   {
     ...
     "Title": "Analytics sync triggered by rebuild",
     "AreaCode": "SYNC",
     "AreaName": "Pre-rebuild sync",
     "Region": "System"
   }
   ```

#### Step 5: Get Personnel Data (Filtered)
...
#### Step 10: Replace Template Placeholders
1. Click **Add an action**
2. Search for and select **Compose** (Data Operation)
3. **Inputs:**
   ```
...
#### Step 11: Create/Update AreaMap.html
1. Click **Add an action**
...
#### Step 12: Handle File Exists Error
...
## 🔄 Flow 3: AreaMap Daily Rebuild (Maintenance)
